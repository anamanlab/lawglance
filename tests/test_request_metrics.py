...
def test_request_metrics_snapshot_reports_rates_and_percentiles() -> None:
    ...
    metrics.record_export_outcome(outcome="allowed", policy_reason="source_export_allowed")
    metrics.record_export_outcome(outcome="blocked", policy_reason="source_export_blocked_by_policy")
    metrics.record_export_outcome(outcome="fetch_failed", policy_reason="source_export_fetch_failed")
